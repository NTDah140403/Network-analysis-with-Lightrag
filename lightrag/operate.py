...
async def kg_query(
    ...
    kw_prompt_temp = PROMPTS["keywords_extraction_custom"]
    # kw_prompt = kw_prompt_temp.format(query=query, examples=examples, language=language)
    kw_prompt = kw_prompt_temp.format(query=query, examples=examples, language=language,history_chat=history_chat)
